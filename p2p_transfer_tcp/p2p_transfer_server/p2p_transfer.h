...
#if 1
#define P2P_TRANSFER_SERVER_IP		"0.0.0.0"//"47.92.106.133"//"127.0.0.1"//"192.168.111.123"
#else
...
{
	uint64_t        magic;          //ħ��У����
	uint64_t        msgid;          //��id,TCPЭ����ֶ�����
	uint64_t        src_device_sn;   //������Ϣ���豸sn
	uint64_t        dst_device_sn;   //������Ϣ���豸sn
	uint32_t        cmd_len;		//���ݳ���
	int             cmd;
	char            cmd_data[0];    //����
};
